...
mod tests {
    ...
    #[test]
    fn bincode_error_paths() {
        use crate::util::test_util::test_bincode_error_paths;
        test_bincode_error_paths::<Vec2>();
        test_bincode_error_paths::<Vec2i>();
        test_bincode_error_paths::<Edge2i>();
        test_bincode_error_paths::<Mat3x3>();
        test_bincode_error_paths::<Rect>();
        test_bincode_error_paths::<Transform>();
    }
}
